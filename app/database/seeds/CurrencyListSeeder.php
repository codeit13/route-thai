...
class CurrencyListSeeder extends Seeder
{
    ...
    public function run()
    {
       $crypto = json_decode('["BTC","ETH","BNB","XRP","USDT","ADA","DOT","UNI","LTC","LINK","DOGE","BCH","XLM","THETA","VET","FIL","USDC","TRX","WBTC","EOS","SOL","KLAY","BSV","CRO","IOST","LUNA","XMR","ATOM","AAVE","BUSD","FTT","BTT","XTZ","AVAX","NEO","ALGO","KSM","EGLD","XEM","HT","RUNE","CAKE","HOT","BTCB","DAI","DASH","HBAR","CHZ","MKR","ZEC"]');
        ...
        $fiat = json_decode('["USD","KRW","INR","THB","JPY","TRY"]');
   ...
   $fiatDetails = (array)json_decode('{"USD":{"name":"UnitedStatesDollar","img":"USD.svg","sname":"USD"},"KRW":{"name":"KoreanWon","img":"KRW.svg","sname":"KRW"},"INR":{"name":"IndianRupee","img":"inr.svg","sname":"INR"},"THB":{"name":"ThaiBaht","img":"thb.svg","sname":"THB"},"JPY":{"name":"JapaneseYen","img":"jp.svg","sname":"JPY"},"TRY":{"name":"TurkishLira","img":"tr.svg","sname":"TRY"} }'
     );
