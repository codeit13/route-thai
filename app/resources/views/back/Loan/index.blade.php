            ...
            <table class="table align-items-center table-flush">
              <thead class="thead-light">
                <tr>
                  ...
                  <th scope="col" class="sort" data-sort="completion">Loan Amount</th>
                  <th scope="col"></th>
                </tr>
              </thead>
              <tbody class="list">
                <tr>
                  <th>
                    <div class="media-body">
                      <span class="name mb-0 text-sm">Hardik Patel</span>
                    </div>
                    <small class="text-muted">patelhardikdeveloper@gmail.com</small>
                  </th>
                  <th scope="row">
                    <div class="media align-items-center">
                      <a href="#" class="avatar rounded-circle mr-3">
                        <img alt="Image placeholder" src="http://127.0.0.1:8000/storage/currency-icons/1.png">
                      </a>
                      <div class="media-body">
                        <span class="name mb-0 text-sm">0.005</span>
                      </div>
                    </div>
                  </th>
                  <th scope="row">
