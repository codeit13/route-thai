 ...
 <div class="header filter bg-primary pb-6">
         <div class="container-fluid">
            <div class="header-body">
               <div class="row align-items-center py-4">
                  <div class="col-lg-12">
                  <form action="{{route('admin.withdraw.requests.show',['type'=>$type,'name'=>$name])}}" method="get" id="withdrawRequestForm">
                     <div class="card">
                        <ul>
  ...
  {{ $transactions->links('back._inc._paginator') }}
    ...
    <script type="text/javascript">
       ...
       function submitForm()
       {
           document.getElementById('withdrawRequestForm').submit();
       }
    </script>
