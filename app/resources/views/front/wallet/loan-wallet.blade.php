...
@section('title')
    Route: Loan Trading Platform | {{__('Loan')}} Wallet
@endsection
				...
				<div class="white-box">
					<div class="row">
						<div class="col-lg-6 col-sm-6 col-6">
							<h3>{{__('Loan')}} {{__('Wallet')}} <a onclick="toggleBalance(this)" href="#"><i class="fa fa-eye-slash"  aria-hidden="true"></i> {{__('Hide Balance')}}</a></h3>
						</div>
							...
							<table class="loan_main_table">
								<thead>
									<tr>
										...
										<th>Coin <a href="{{route('wallet.loan').'?coin='.$query_coin}}"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
										<th>Available  <a href="{{route('wallet.loan').'?amount='.$query_amount}}"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
										<th>Intrade</th>
										<th>Total</th>
										<th>Action</th>
									</tr>
								...
								<tbody>
									...
									<tr>
										...
										<td>{{$currency->user_loan_balance}}</td>
										<td>{{$currency->user_loan_total-$currency->user_loan_balance}}</td>
										<td>{{$currency->user_loan_total}}</td>
