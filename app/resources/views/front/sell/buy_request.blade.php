	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 hidden-xs col-sm-12 col-xs-12">
				<h4>Expect to receive payment in <span id="timer">00:00:31</span> <a class="visible-xs" href="#"  data-toggle="modal" data-target="#exampleModal2"><img src="{{ asset('front/img/icon-26.png') }}" alt=""/></a></h4>
			</div>
		...
		<div class="row">
			<div class="col-lg-6 xs-flush col-sm-6 col-xs-12">
							...
							<div class="col-lg-4 col-sm-4 col-12">
								<div class="row">
									...
									<div class="col-lg-12 xs-right col-sm-12 col-6">
										<div id="ID5268172_USD__10_s"><img class="coin_image" src="{{ $transcation->currency->getMedia('icon')->first()->getUrl() }}" alt=""/><span class="hidden-xs">{{ $transcation->currency->name }}</span><span class="visible-xs red-c">{{ $transcation->currency->short_name }}</span>
										</div>
									</div>
								</div>
							</div>
				...
				{{-- <div class="col-lg-12 flush  space-xs col-sm-12 col-12">
					<div class="row">
						<div class="col-lg-9 col-sm-9 col-8"><a href="#" class="btn-success confirm">Confirm receipt</a>
						</div>
...
@section('page_scripts')
	...
	{{-- ajax to check have valid buyer or not --}}
	<script>
		function checkValidBuyer(){
			$.ajax({
		        url: '{{ route("sell.buyer_request_confrim",['trans_id'=>$transcation->trans_id]) }}',
		        type:'post',
		        dataType:'json',
	    ...
	    setInterval(checkValidBuyer,1000);
	</script>
