               ...
               <div class="card">
                  <div class="row">
                     ...
                     <div class="col-lg-7 col-sm-7 col-7">
                        ...
                        <p>Volume: <span><span id="thb_ada_volume">6,447,291.85 USD</span>
                        </p>
                     </div>
                     <div class="col-lg-3 col-sm-3 flush col-3 text-right"> <span class="text-green side_span">+0.73%</span>
                     </div>
                  </div>
               </div>
            </li>
            <li class="col-lg-3 col-sm-3 col-xs-12">
               <div class="card">
                  <div class="row">
                     ...
                     <div class="col-lg-3 col-sm-3 flush col-3 text-right"> <span class="text-green side_span">+0.13%</span>
                     </div>
                  </div>
               </div>
            </li>
            ...
            <li class="col-lg-3 col-sm-3 col-xs-12">
               <div class="card">
                  <div class="row">
                     ...
                     <div class="col-lg-3 col-sm-3 flush col-3 text-right"> <span class="text-green side_span">-8.38</span>
                     </div>
                  </div>
               </div>
            </li>
         ...
         <div class="col xs-card">
            <div class="card">
               <div class="main_data_dable">
                  <table class="table table-striped table-hover">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td><span id="bb_btc_p">$ 55064.14</span>
                           </td>
                           <td><span id="bm_btc" class="text-red">-0.75%</span>
                           </td>
                           <td>
                              <img src='{{ asset("front/img/Image 12.png") }}'>
                           </td>
                           <td><a href="#" class="table_btn">Buy</a>
                           </td>
                        </tr>
                        <tr>
                           <th scope="row" class="ft_first">
                              <img src='{{ asset("front/img/ethereum.png")}}' alt="">ETH <span>Ethereum</span>
                           </th>
                           <td><span id="bb_btc_p">$2,095.81</span>
                           </td>
                           <td><span id="bm_btc" class="text-green">+5.26%</span>
                           </td>
                           <td>
                              <img src='{{ asset("front/img/Image 12.png") }}'>
                           </td>
                        ...
                        <tr>
                           <th scope="row" class="ft_first">
                              <img src='{{ asset("front/img/bnb.png")}}' alt="">BNB <span>BNB</span>
                           </th>
                           <td><span id="bb_btc_p">$339.63</span>
                           </td>
                           <td><span id="bm_btc" class="text-red">-0.75%</span>
                           </td>
                           <td>
                        ...
                        <tr>
                           <th scope="row" class="ft_first">
                              <img src='{{ asset("front/img/busd.png")}}' alt="">BUSD <span>BNB</span>
                           </th>
                           <td><span id="bb_btc_p">$1.99</span>
                           </td>
                           <td><span id="bm_btc" class="text-green">-0.75%</span>
                           </td>
                           <td>
                              <img src='{{ asset("front/img/Image 12.png") }}'>
                           </td>
                  ...
                  <div class="side_center text-center"> <a href="#">View more markets</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-lg-4 col-sm-5 col-xs-4 text-center">
            ...
            <div class="inner_div">
               ...
               <div class="side_inner">
                  <h3>Mobile apps</h3>
                  <p>Stay on top of the markets with the Route app for Android or iOS.</p>
               </div>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col text-center">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
               <li class="nav-item"> <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Buy Crypto</a>
               </li>
               <li class="nav-item"> <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Learn about Cryptocurrency</a>
               </li>
               <li class="nav-item"> <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Trade</a>
               </li>
               <li class="nav-item"> <a class="nav-link" id="earn-tab" data-toggle="tab" href="#earn" role="tab" aria-controls="earn" aria-selected="false">Earn</a>
               </li>
            </ul>
   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-6 col-xs-12 col-sm-6">
            <div class="dd_content"> <span>DOWNLOAD APP</span>
               ...
               <a href="#">
                  <img src='{{ asset("front/img/appstore.png")}}' alt="">
               </a>
               <a href="#">
                  <img src='{{ asset("front/img/playstore.png")}}' alt="">
               </a>
            </div>
         </div>
...
</section> <div class="modal alert_poup fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
