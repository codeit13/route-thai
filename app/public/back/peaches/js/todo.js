...
$('.approve-btn').click(function() {
  ...
  if (confirm("Are you sure you want to approve " + username + "'s POints Request.")) {
    jQuery.ajax({
      type: 'POST',
      url: 'assets/peaches/action.php',
      data: {
...
$('.reject-btn').click(function() {
  ...
  if (confirm("Are you sure you want to reject " + username + "'s Points Request.")) {
    jQuery.ajax({
      type: 'POST',
      url: 'assets/peaches/action.php',
      data: {
