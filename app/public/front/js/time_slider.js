class Slider {
    ...
    constructor({ DOMselector, sliders }) {
        ...
        this.sliderWidth = 120;                                     // Slider width
        this.sliderHeight = 120;                                    // Slider length
    ...
    drawHandle(slider, initialAngle, group) {
        ...
        handle.setAttribute('r', this.arcFractionThickness / 4);
    ...
    createLegendUI() {
        ...
        this.sliders.forEach((slider, index) => {
            ...
            thirdSpan.innerText = slider.timer ?? 0;
